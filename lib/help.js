...
const TOPICS = {
  ...
  network: {
    intro: 'requests and logs record all the time; a capture records only while it runs.',
    commands: ['requests', 'body', 'logs', 'capture', 'route', 'network'],
  },
  devtools: {
...
Times (requests, logs, watch) are local, with their UTC offset: 18:16:15.721-06:00.
