...
Modes (watch, capture, route, network off or slow) stay on until turned off; the prompt shows the
selected tab's: (watch routes:1) pw>. tab, watch, capture, route, network and modes on their own show
their state and what you can run next.
...
const COMMANDS = {
  ...
  modes: {
    ...
    detail: 'The modes are watch, network off or slow, route and capture. Each is turned on and off with its own\ncommand: watch on|off, network off|slow|on, route <glob> ... | route off <glob>|--all, capture on|off.\n\nmodes off turns off every one in every tab; a capture it stops is kept for capture to show.',
  },
  dialog: {
