...
const READ_ONLY = new Set(['tabs', 'info', 'title', 'url', 'text', 'html', 'attrs', 'count', 'visible', 'links', 'inputs',
  'snapshot', 'screenshot', 'wait', 'sleep', 'recent', 'body', 'logs', 'routes', 'cookies', 'storage', 'capture', 'help']);
...
const INSPECTION = ['info', 'title', 'url', 'text', 'html', 'attrs', 'links', 'inputs', 'eval', 'raw', 'cookies', 'storage', 'capture', 'body', 'logs', 'snapshot', 'watch'];
